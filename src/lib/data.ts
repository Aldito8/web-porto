...
export const projectsData: Project[] = [
    ...
    {
        title: "Kepengen App",
        description: "This application is designed to help users record, manage, and track their savings toward their dream thing. With a simple and user-friendly interface, users can easily stay motivated and organized while reaching their goals.",
